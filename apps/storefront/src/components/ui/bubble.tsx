...
export interface BubbleProps extends React.ComponentProps<"div">, VariantProps<typeof bubbleVariants> {
	align?: "start" | "end";
}
...
export function BubbleContent({ asChild = false, className, ...props }: BubbleContentProps) {
...
export function BubbleReactions({ side = "bottom", align = "end", className, ...props }: BubbleReactionsProps) {
	return (
		<div
